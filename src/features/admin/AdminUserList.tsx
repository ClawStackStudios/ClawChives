                ...
                <tr key={u.uuid} className="hover:bg-slate-800/30 transition-colors text-sm group">
                  ...
                  <td className="px-6 py-4 text-center">
                    <div className="flex flex-col items-center">
                      <span className="font-bold">{u.pinchmark_count}</span>
                      <span className="text-[10px] text-slate-600 uppercase">Pinchmarks</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 text-center">
                    <div className="flex flex-col items-center">
            ...
            >
              ...
              <div className="bg-slate-950 rounded-2xl p-4 mb-6 border border-slate-800">
                ...
                <ul className="space-y-2 text-xs text-slate-500">
                  <li className="flex items-center gap-2"><FileText className="w-3 h-3" /> {deleteTarget.pinchmark_count} Pinchmarks & {deleteTarget.folder_count} Folders</li>
