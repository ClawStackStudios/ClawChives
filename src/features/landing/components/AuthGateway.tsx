      ...
      <div className="w-full max-w-md space-y-6">
        <div className="flex justify-center gap-2 p-1.5 bg-slate-200/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-full backdrop-blur-sm">
          ...
          <button
            ...
            className={`flex-1 px-4 py-2.5 text-xs font-bold rounded-full transition-all uppercase tracking-widest ${gatewayMode === "agent" ? "bg-red-600 text-white shadow-lg shadow-red-900/20" : "text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200"}`}
          >
            🤖 I'm an Agent
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-xl">
          {gatewayMode === "human" ? (
            ...
            <div className="animate-in fade-in zoom-in duration-300">
              ...
              <Button
                onClick={onCreateAccount}
                className="w-full mt-8 bg-red-600 hover:bg-red-700 text-white shadow-lg shadow-red-900/20"
              >
