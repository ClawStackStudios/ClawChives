    ...
    <div className="h-full flex flex-col bg-white dark:bg-slate-900">
      <div className="p-4 border-b border-slate-200 dark:border-slate-800">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="font-bold text-lg text-slate-900 dark:text-slate-50">ClawChives</span>
        </div>
      </div>
            ...
            {showNewFolder && (
              <div className="px-3 mb-2">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  autoFocus
                />
              </div>
            )}
